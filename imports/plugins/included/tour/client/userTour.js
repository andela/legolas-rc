export function userTour() {
  ...
  intro.setOptions({
    steps: [
      {
        intro: "<h3 class='text-center'>Welcome to Legolas RC</h3>"
      },
      {
        intro: "<h4 class='text-center'>Not sure of how to find products of your interest?</h4>"
      },
      {
        element: "#userTourSearch",
        intro: "Type a product name in the search field. You will find all related products"
      },
      {
      ...
      },
      {
        ...
        intro: "Click on the cart symbol in order to reach your cart."
      },
      {
        element: "#userTour",
        intro: "Ever need to take a tour again, just click on the tour button again"
      },
      {
